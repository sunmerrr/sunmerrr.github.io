...
작품을 쌓아두고 그 외 들어가는 비용은 지원 사업으로 대체한다    
...
- 자존심 안부리면 좋지 않을지..
- 같지 발전한다는 생각으로 이야기를 많이 나누면 좋지 않을까
- 칭찬과 리뷰를 좀 해줄 수 있으면 좋을 것 같다.
...
- 무슨 일이 있을때 잘 공유해줄 수 있으면 좋을 것 같다.    
  내가 쉬거나, 자리에 없는 상황에서 이슈가 있으면 전달을 받지 못한 경우가 있을 때가 있었다. 왜 말을 안해주는지는 모르겠다.     
