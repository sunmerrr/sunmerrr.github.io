...
나는 리팩토링은 무조건 좋은 것이라고 생각했다. 개발자에게 리팩도링은 필수적인 요소가 맞다. 내가 어제 짠 코드를 조금 더 읽기 쉽게 리팩토링하는 것은 나에게도 좋지만 동료 개발자들에게도 좋은 일이다. 선임 개발자의 조언을 듣고 하는 리팩토링은 나를 발전 나를 발전할 수 있는 계기를 마련해준다. 그런데 나는 몰랐다. 과거 코드를 고치는 것에 리팩토링이라는 답만 존재하지 않는 다는 것을..     
