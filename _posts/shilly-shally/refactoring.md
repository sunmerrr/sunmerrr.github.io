...
개발자에게 리팩도링은 필수적인 요소가 맞긴 하다. 내가 어제 짠 코드를 조금 더 읽기 쉽게 리팩토링하는 것은 나에게도 좋지만 동료 개발자들에게도 좋은 일이다. 선임 개발자의 조언을 듣고 하는 리팩토링은 내가 발전할 수 있는 계기가 된다. 그런데 이번에는 생각이 조금 짧았던 것 같다. 이미 엉망이된 과거 코드를 고칠때는 리팩토링이 무조건 적으로 좋을 수만은 없는 것이다.     
이런 상황에서는 리팩토링을 하는 것보다 새롭고 깔끔하게 다시 짜는것이 정신건강에 좋을 것 같다는 말을 과거의 나에게 해주고 싶은 심정이다..
